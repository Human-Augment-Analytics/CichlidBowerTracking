...
Please proceed with these steps and see further explanations below. In this folder are some add-on scripts for training a transformer re-ID model, which has not been implemented in DeepLabCut v3.0 PyTorch engine (as of November 2024)
