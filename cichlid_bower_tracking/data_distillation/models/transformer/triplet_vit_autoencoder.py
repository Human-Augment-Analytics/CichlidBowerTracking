...
class TripletViTAutoencoder(nn.Module):
    def __init__(self, embed_dim: int, n_heads: int, n_encoders=8, n_decoders=8, encoder_dropout=0.1, decoder_dropout=0.1, encoder_mlp_ratio=4.0, decoder_mlp_ratio=4.0, batch_size=8, img_channels=3, img_dim=256, \
