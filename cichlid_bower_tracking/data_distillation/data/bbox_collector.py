...
class BBoxCollector:
    def __init__(self, video_file: str, tracks_file: str, bboxes_dir: str, dim=128, filename=None):
        '''
    ...
    def _save_images(self, imgtype='png') -> None:
        ...
        for track_id, bbox in self.bboxes.items():
            ...
            save_image(bbox_tensor, os.path.join(self.bboxes_dir, f'{track_id}_{counts[track_id]}.{imgtype}'))
