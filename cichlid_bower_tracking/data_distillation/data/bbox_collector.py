...
class BBoxCollector:
    def __init__(self, video_file: str, detections_file: str, video_index: int, bboxes_dir: str, dim=128, filename=None):
        '''
        ...
        Inputs:
            ...
            video_index: an integer indicating the index of the video tpo be collected from.
    ...
    def _save_images(self, imgtype='png') -> None:
        ...
        for frame_idx, bboxes_list in self.bboxes.items():
            for bbox in bboxes_list:
                ...
                save_image(bbox_tensor, os.path.join(self.bboxes_dir, f'{"0" * (4 - math.floor(1 + math.log10(self.video_index)))}{self.video_index}vid_frame{frame_idx}_n{"0" * (12 - math.floor(1 + math.log10(counts[frame_idx])))}.{imgtype}'))
