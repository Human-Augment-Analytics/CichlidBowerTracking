...
parser.add_argument('DataType', type = str, choices=['Prep','Depth','Cluster','ClusterClassification', 'ClipVideos', 'CollectBBoxes', 'TrackFish', 'Train3DResnet', 'ManualLabelVideos','Summary','All'], help = 'What type of analysis to perform')
