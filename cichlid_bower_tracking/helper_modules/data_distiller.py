...
from helper_modules.bbox_collector import BBoxCollector
...
class DataDistiller:
    def __init__(self, video_file: str, tracks_file: str, channels: int, dim: int, avg_imgs_file: str, dtype=torch.uint64):
        '''
        ...
        Inputs:
            ...
            avg_imgs_file: a string indicating the name of the NumPy .npz file in which the video's track average images will be stored.
        ...
        self.avg_imgs_file = avg_imgs_file
    ...
    def _save_avg_imgs(self, avg_imgs: Dict) -> None:
        '''
        Saves the video's computed track average bbox images into a compressed NumPy (.npz) file.
        ...
        np.savez_compressed(self.avg_imgs_file, {track_id:avg for track_id, avg in avg_imgs.items()})
